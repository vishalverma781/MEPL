  ...
  return (
    <div className="w-full min-h-screen flex justify-center items-start p-10">
      <div className="bg-white shadow-2xl rounded-2xl p-8 w-full max-w-7xl">
        <h2 className="text-3xl font-bold text-center mb-6 text-gray-900">👥 All Employees</h2>
            ...
            <table className="w-full border border-gray-300 rounded-xl overflow-hidden">
              ...
              <tbody>
                {currentEmployees.map((emp) => (
                  <tr key={emp._id} className="border-b border-gray-200 hover:bg-gray-100 transition text-lg">
                    <td className="p-5">
                      {emp.profilePic ? (
                        <img
      ...
      {selectedEmployee && (
        <div className="fixed inset-0 flex items-center justify-center bg-black/40 z-50">
          <div className="bg-white rounded-2xl shadow-2xl w-[90%] max-w-4xl p-6 overflow-y-auto max-h-[90vh]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
              ...
              <Section title="💼 Employment Details">
                ...
                <GridRow label="Username" value={selectedEmployee.username} /> {/* ✅ NEW FIELD */}
